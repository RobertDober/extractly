...
- [Extractly](#extractly)
  ...
  - [Extractly.Toc.render/2](#extractlytocrender2)
      - [Markdown](#markdown)
        - [Remove Gaps](#removegaps)
        - [Github README Links](#githubreadmelinks)
      - [HTML](#html)
        - [Exlcuding levels and changing list styles](#exlcudinglevelsandchangingliststyles)
      - [PushList](#pushlist)
      - [AST tree](#asttree)
      - [Unsupported Formats](#unsupportedformats)
